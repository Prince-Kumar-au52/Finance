...
const { addWallet, getAllWallet, updateWallet, deleteWallet, getUserMoney, getWalletForUser } = require('../controllers/wallet');
...
router.get('/getWalletforUser',auth,getWalletForUser)
